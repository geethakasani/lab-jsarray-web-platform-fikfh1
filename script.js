// Challenge 1: Create an Array "myFavSuperheroes" and add all your favourite superhero names as an array element (Please note, you should add atleast 5 names).
 var myFavSuperheroes = ["Spider-Man", "Iron Man", "Wonder Woman", "Batman", "Captain America"];
...
myFavSuperheroes[myFavSuperheroes.length-2]="geethanjali";
...
myFavSuperheroes.unshift("Prasanna");
...
myFavSuperheroes.splice(2,0,"prasanna");
console.log(myFavSuperheroes);
...
myFavSuperheroes.splice(3,2,"moni");
console.log(myFavSuperheroes);
...
var superheroUniverse=[["Spider-Man", "Iron Man", "Captain America"],["Batman", "Wonder Woman", "Superman"]]
